    ...
    <div className="space-y-4">
      <section className="grid gap-4 sm:grid-cols-3">
        ...
        <Card className="p-4">
          ...
          <p className="mt-2 text-2xl font-bold text-slate-950">{formatCurrency(totalAmount)}</p>
        </Card>
      </section>
                    ...
                    {expense.participants.map((participant) => (
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-semibold text-slate-700">{participant.member.name}</span>
                        </div>
